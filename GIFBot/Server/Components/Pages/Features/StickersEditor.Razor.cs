...
namespace GIFBot.Server.Components.Pages.Features
{
   public partial class StickersEditor : IAsyncDisposable
   {
      ...
      protected override async Task OnInitializedAsync()
      {
         ...
         {
            await InvokeAsync(() => UpdateStickerPosition(top, left));
         });
      ...
      private async Task GetStickerDataFromHub()
      {
         ...
         if (mStickerData.Access == global::GIFBot.Shared.AnimationEnums.AccessType.UserGroup)
         {
      ...
      private void OnAccessLevelChange(int? value)
      {
         if (value.HasValue)
         {
            ...
            mStickerData.Access = (global::GIFBot.Shared.AnimationEnums.AccessType)value.Value;
         }
      }
      ...
      private async Task HandleDisplayTestModeChanged(bool isDisplayTestModeOn, StickerEntryData stickerToTest)
      {
         ...
         global::GIFBot.Shared.AnimationEnums.AnimationLayer layer = global::GIFBot.Shared.AnimationEnums.AnimationLayer.Primary;
      ...
      private async Task OnLayerChange(int? value)
      {
         if (value.HasValue)
         {
            ...
            CurrentlyEditedSticker.Layer = (global::GIFBot.Shared.AnimationEnums.AnimationLayer)value.Value;
      ...
      private void SetPlacementComponentCanvasSize(StickerEntryData sticker)
      {
         if (sticker != null)
         {
            if (sticker.Layer == global::GIFBot.Shared.AnimationEnums.AnimationLayer.Primary)
            {
