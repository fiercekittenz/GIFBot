...
|--------|-------|----------|
| Architecture, migration planning, scope decisions, code review | Mark | "Plan the .NET 10 migration", "Review the consolidation approach" |
| Blazor components, MudBlazor migration, UI/UX, frontend pages | Helly | "Replace Telerik grid with MudBlazor", "Build the new layout" |
